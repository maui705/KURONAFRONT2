...
export class UsuarioService {
  ...
  getQuantitUsuByRol(): Observable<QueryNativeDTO[]> {
      return this.http.get<QueryNativeDTO[]>(`${this.url}/cantidad-usuario-rol`);
  }
  getPagaTotal(): Observable<QueryNative2DTO[]> {
      return this.http.get<QueryNative2DTO[]>(`${this.url}/buscar-pagos-usuario`);
  }
}